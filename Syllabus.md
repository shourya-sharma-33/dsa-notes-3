...
* Pascal Triangle / nCr Optimization
* Majority Element II
* 3 Sum
* 4 Sum
...
* Median of Two Sorted Arrays (Brute/Better)
...
* Kahn’s Algorithm
* Cycle Detection (Topo BFS)
* Course Schedule
* Alien Dictionary
* Shortest Path in DAG
* Shortest Path Unit Weight
* Word Ladder I
* Word Ladder II
* Dijkstra (PQ)
* Dijkstra (Set)
...
* Kruskal’s Algorithm
* DSU Applications (Islands / Accounts / Network)
...
* Edit Distance
* Wildcard Matching
* Stock Buy Sell Series (I → IV + Cooldown + Fee)
...
* Intersection of Y Linked Lists
